...
force -freeze sim:/neuron/index 10#0 0
run
force -freeze sim:/neuron/index 10#1 0
run
force -freeze sim:/neuron/index 10#2 0
run
force -freeze sim:/neuron/index 10#3 0
run
force -freeze sim:/neuron/index 10#4 0
run
